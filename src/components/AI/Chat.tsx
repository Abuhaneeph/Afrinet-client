...
const AIChatModal = ({ isOpen, onClose, context = 'general' }) => {
  ...
  const clearChat = () => {
    setMessages([
      {
        id: '1',
        text: "Chat cleared! I'm still here to help with Afrinet, blockchain, and DeFi questions. What would you like to know?",
        isUser: false,
        timestamp: new Date()
      }
    ]);
  ...
  // Quick action prompts specific to Afrinet
  const quickActions = [
        ...
        >
          ...
          <div className="drag-handle flex-shrink-0 flex items-center justify-between p-4 border-b border-stone-200 bg-white rounded-t-2xl cursor-move">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="font-semibold text-stone-900">Afrinet AI</h3>
