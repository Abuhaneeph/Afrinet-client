...
const AjoEsusuInterface = () => {
  ...
  // Get supported tokens (excluding MNT which is id: 1)
  ...
  const handleRegisterUser = async () => {
    ...
    try {
      ...
      if (isUserRegistered) {
        setIsRegistered(true);
        setSuccessMessage('You are already registered! Welcome back to Afrinet Ajo/Esusu.');
      ...
      setIsRegistered(true);
      setSuccessMessage('Successfully registered! Welcome to Afrinet Ajo/Esusu.');
      initializeData(); // Refresh data
    } catch (error) {
 ...
 const handleCreateGroup = async () => {
  ...
  const handleContribute = async (groupId, tokenAddress,amount) => {
    ...
    try {
      ...
      if(tokenAddress == '0xCcD4D22E24Ab5f9FD441a6E27bC583d241554a3c'){
...
const handleCopyInviteCode = async (inviteCode) => {
    ...
    return (
      <div className="max-w-6xl mx-auto flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-stone-600">Loading Afrinet Ajo/Esusu data...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="max-w-6xl mx-auto flex items-center justify-center min-h-screen">
        <div className="text-center bg-white rounded-2xl p-8 shadow-sm border border-stone-200">
          ...
          <p className="text-stone-600">Please connect your wallet to access Afrinet Ajo/Esusu</p>
        </div>
      </div>
    );
  }
   ...
   <div className="max-w-md mx-auto mt-16">
    <div className="bg-white rounded-2xl p-8 shadow-sm border border-stone-200">
      <div className="text-center mb-6">
        ...
        <h2 className="text-2xl font-bold text-stone-800 mb-2">Welcome to Afrinet Ajo/Esusu</h2>
  ...
  return (
    ...
    <div className="max-w-6xl mx-auto space-y-8">
      <div className="text-center">
        <h1 className="text-3xl font-bold text-stone-800 mb-2">Afrinet Ajo/Esusu</h1>
        ...
        {activeTab === 'create' && isAgent  &&(
          <div className="p-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                <h3 className="text-lg font-semibold text-stone-800">How Afrinet Ajo/Esusu Works</h3>
  ...
  <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div className="bg-white rounded-xl p-6 w-96 max-w-md">
      ...
      <div className="text-center py-6 border-t border-stone-200">
        <p className="text-stone-500 text-sm">
          Afrinet Ajo/Esusu - Building financial inclusion through traditional savings circles powered by blockchain technology
        </p>
      </div>
    </div>
    </>
