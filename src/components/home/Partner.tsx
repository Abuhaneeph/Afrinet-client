  ...
  const partners = [
    {
      ...
      logo: "https://pbs.twimg.com/profile_images/1891836818850709509/290NJBzU_400x400.jpg",
      website: "https://Mantle.com",
...
,
  ...
  {
    icon: () => <img src="https://pbs.twimg.com/profile_images/1891836818850709509/290NJBzU_400x400.jpg" alt="Mantle" className="w-10 h-10 object-contain" />,
    title: "Testnet Deployed",
    description: "MVP live on Mantle Sepolia testnet with core features",
